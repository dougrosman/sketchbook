...
function draw() {
  ...
  if(1 - lerpAmount0 < 0.0006) {
    ...
    buttons1 = generateButtons(num, Math.floor(random(upper, lower)), 0, false, Math.random());
    //print("change1");
  }
  
  if(lerpAmount0 < 0.0006) {
    buttons2 = generateButtons(num, Math.floor(random(upper, lower)), 0, false, Math.random());
    //print("change2");
  }
